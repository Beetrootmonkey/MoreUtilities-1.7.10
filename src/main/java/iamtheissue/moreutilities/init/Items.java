...
public class Items
{
	...
	{
		raw_squid = new ItemFood(2, 0.2f, false).setUnlocalizedName("raw_squid").setTextureName(Reference.MOD_ID + ":raw_squid");
		...
		cooked_horse = new ItemFood(8, 0.75f, true).setUnlocalizedName("cooked_horse").setTextureName(Reference.MOD_ID + ":cooked_horse");
		...
		cooked_mutton = new ItemFood(6, 0.7f, true).setUnlocalizedName("cooked_mutton").setTextureName(Reference.MOD_ID + ":cooked_mutton");
